...
class TestAccountAvalaraAddressValidation(TestAvataxCommon):
    ...
    def _test_address_validation_flow(self):
        ...
        self.assertEqual(partner.street, '3400', 'The validated address is incorrect.')
        self.assertEqual(partner.street2, '250 Executive Park Blvd', 'The validated address is incorrect.')
        self.assertEqual(partner.city, 'San Francisco', 'The validated address is incorrect.')
        self.assertEqual(partner.zip, '94134-3394', 'The validated address is incorrect.')
