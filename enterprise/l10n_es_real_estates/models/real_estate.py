...
class RealEstate(models.Model):
    ...
    portal = fields.Char(string='Portal', size=3, help="Portal number.")
    stairs = fields.Char(string='Stairs', size=3, help="Stairs number.")
    floor = fields.Char(string='Floor Number', size=3)
    door = fields.Char(string='Door', size=3, help="Door number.")
